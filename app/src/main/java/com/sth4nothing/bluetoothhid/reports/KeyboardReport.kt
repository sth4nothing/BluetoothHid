...
//        const val KEYCODE_SHIFT_QUESTION_MARK = 56
        ...
        val KeyEventMap = mapOf<Int,Int>(
            ...
            KeyEvent.KEYCODE_NUMPAD_DIVIDE to 84,
            KeyEvent.KEYCODE_NUMPAD_MULTIPLY to 85,
            KeyEvent.KEYCODE_NUMPAD_SUBTRACT to 86,
            KeyEvent.KEYCODE_NUMPAD_ADD to 87,
            KeyEvent.KEYCODE_NUMPAD_ENTER to 88,
            KeyEvent.KEYCODE_NUMPAD_1 to 89,
            KeyEvent.KEYCODE_NUMPAD_2 to 90,
            KeyEvent.KEYCODE_NUMPAD_3 to 91,
            KeyEvent.KEYCODE_NUMPAD_4 to 92,
            KeyEvent.KEYCODE_NUMPAD_5 to 93,
            KeyEvent.KEYCODE_NUMPAD_6 to 94,
            KeyEvent.KEYCODE_NUMPAD_7 to 95,
            KeyEvent.KEYCODE_NUMPAD_8 to 96,
            KeyEvent.KEYCODE_NUMPAD_9 to 97,
            KeyEvent.KEYCODE_NUMPAD_0 to 98,
            KeyEvent.KEYCODE_NUMPAD_DOT to 99,
        )
    }
}